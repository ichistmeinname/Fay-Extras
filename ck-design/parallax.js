/** @constructor
*/
var Fay$CKDesign$Parallax = function(){
/*******************************************************************************
 * Thunks.
 */
...
var ConstantsAndHelpers$preloadId = new Fay$$$(function(){
  return Fay$$list("#preload");
});
var ConstantsAndHelpers$textID = new Fay$$$(function(){
  return Fay$$list("#text");
});
var ConstantsAndHelpers$linkClass = new Fay$$$(function(){
  return Fay$$list("link");
});
var ConstantsAndHelpers$movableClass = new Fay$$$(function(){
  return Fay$$list("movable");
});
var ConstantsAndHelpers$navItemClass = new Fay$$$(function(){
  return Fay$$list("nav-item");
});
var ConstantsAndHelpers$activeClass = new Fay$$$(function(){
  return Fay$$list("active");
});
var ConstantsAndHelpers$blackWhiteClass = new Fay$$$(function(){
  return Fay$$list("black_white");
});
var ConstantsAndHelpers$bubbleImageClass = new Fay$$$(function(){
  return Fay$$list(".bubble");
});
var ConstantsAndHelpers$thumbnailClass = new Fay$$$(function(){
  return Fay$$list("thumbnail");
});
var ConstantsAndHelpers$scaleZeroClass = new Fay$$$(function(){
  return Fay$$list("scaleZero");
});
var ConstantsAndHelpers$navSlideClass = new Fay$$$(function(){
  return Fay$$list("navSlide");
});
var ConstantsAndHelpers$mouseEnterData = new Fay$$$(function(){
  return Fay$$list("mouseenter");
});
var ConstantsAndHelpers$mouseLeaveData = new Fay$$$(function(){
  return Fay$$list("mouseleave");
});
var ConstantsAndHelpers$hoverObjectData = new Fay$$$(function(){
  return Fay$$list("hoverobj");
});
var ConstantsAndHelpers$scrollPositionData = new Fay$$$(function(){
  return Fay$$list("scrollpos");
});
var ConstantsAndHelpers$hrefData = new Fay$$$(function(){
  return Fay$$list("href");
});
var ConstantsAndHelpers$clickData = new Fay$$$(function(){
  return Fay$$list("click");
});
var ConstantsAndHelpers$startData = new Fay$$$(function(){
  return Fay$$list("start");
});
var ConstantsAndHelpers$endData = new Fay$$$(function(){
  return Fay$$list("end");
});
var ConstantsAndHelpers$speedData = new Fay$$$(function(){
  return Fay$$list("speed");
});
var ConstantsAndHelpers$offsetData = new Fay$$$(function(){
  return Fay$$list("offset");
});
var ConstantsAndHelpers$hoverClassData = new Fay$$$(function(){
  return Fay$$list("hoverclass");
});
var ConstantsAndHelpers$linkTagData = new Fay$$$(function(){
  return Fay$$list("click");
});
var ConstantsAndHelpers$visibilityData = new Fay$$$(function(){
  return Fay$$list("vis");
});
var FFIExtras$searchQuery = new Fay$$$(function(){
  return new Fay$$Monad(Fay$$jsToFay_string($(location).attr('search')));
});
var FFIExtras$get = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
...
var FFIExtras$appendString = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$prependString = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$attrDouble = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$setDataAttr = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
...
var FFIExtras$dataAttr = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$dataAttrDouble = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$hoverEnterLeave = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
...
var FFIExtras$cssDouble = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$setMarginLeft = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$setBackgroundImage = function($p1){
  return new Fay$$$(function(){
    var imageName = $p1;
    return (function(){
      var toURL = function($p1){
        return new Fay$$$(function(){
          var image = $p1;
          return Fay$$_(Fay$$_(Prelude$$43$$43$)(Fay$$list("url(")))(Fay$$_(Fay$$_(Prelude$$43$$43$)(image))(Fay$$list(")")));
        });
      };
      return Fay$$_(FFIExtras$setBackgroundImage$39$)(Fay$$_(toURL)(imageName));
    })();
  });
};
var FFIExtras$setBackgroundImage$39$ = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$setPositionY = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$setPositionX = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["unknown"],Fay$$fayToJs(["user","JQuery",[]],$p2).css("left", Fay$$fayToJs_double($p1))));
    });
  };
};
var FFIExtras$animateMarginLeft = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
...
var FFIExtras$animateScrollTop = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
...
var FFIExtras$animateScrollLeft = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        return new Fay$$Monad(Fay$$jsToFay(["unknown"],Fay$$fayToJs(["user","JQuery",[]],$p3).animate({'scrollLeft': Fay$$fayToJs_double($p1)}, Fay$$fayToJs_double($p2))));
      });
    };
  };
};
var FFIExtras$unbind = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
var FFIExtras$triggerScroll = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],Fay$$fayToJs(["user","JQuery",[]],$p1)['trigger']('scroll')));
  });
};
var FFIExtras$turnOffClick = new Fay$$$(function(){
  return Fay$$_(FFIExtras$unbind)(Fay$$list("click"));
});
var FFIExtras$turnOffHover = function($p1){
  return new Fay$$$(function(){
    var object = $p1;
    return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(FFIExtras$unbind)(Fay$$list("mouseenter")))(object)))(Fay$$_(Fay$$_(FFIExtras$unbind)(Fay$$list("mouseleave")))(object));
  });
};
var FFIExtras$triggerHover = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],Fay$$fayToJs(["user","JQuery",[]],$p1)['trigger']('scroll')));
  });
};
var FFIExtras$windowWidth = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay_double(Fay$$fayToJs(["user","JQuery",[]],$p1).width()));
  });
};
var FFIExtras$setLocation = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],window.location = Fay$$fayToJs_string($p1)));
  });
};
var FFIExtras$body = new Fay$$$(function(){
  return Fay$$_(JQuery$select)(Fay$$list("body"));
});
var FFIExtras$$_window = new Fay$$$(function(){
  return Fay$$jsToFay(["user","Element",[]],window);
});
var FFIExtras$document = new Fay$$$(function(){
  return Fay$$jsToFay(["user","Document",[]],document);
});
var FFIExtras$log = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],console.log(Fay$$fayToJs_string($p1))));
  });
};
var FayExtras$Always = new Fay$$$(function(){
  return new $_FayExtras$Always();
});
var FayExtras$Range = function(slot1){
  return function(slot2){
    return new Fay$$$(function(){
      return new $_FayExtras$Range(slot1,slot2);
    });
  };
};
var FayExtras$Horizontal = new Fay$$$(function(){
  return new $_FayExtras$Horizontal();
});
var FayExtras$Vertical = new Fay$$$(function(){
  return new $_FayExtras$Vertical();
});
var FayExtras$selectClass = function($p1){
  return new Fay$$$(function(){
    var className = $p1;
    return Fay$$_(JQuery$select)(Fay$$_(Fay$$_(Fay$$cons)("."))(className));
  });
};
var FayExtras$addHref = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      var element = $p2;
      return (function(){
        var onClick = function($p1){
          return function($p2){
            return new Fay$$$(function(){
              var href = $p1;
              return Fay$$_(FFIExtras$setLocation)(href);
            });
          };
        };
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
          var object = $p1;
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttr)(ConstantsAndHelpers$hrefData))(object)))(function($p1){
            var href = $p1;
            return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttr)(ConstantsAndHelpers$clickData))(object)))(JQuery$select)))(function($p1){
              var clickObject = $p1;
...
var FayExtras$addActive = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        var element = $p3;
        ...
        return (function(){
          var onClick = function($p1){
            return new Fay$$$(function(){
              return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FayExtras$selectClass)(ConstantsAndHelpers$activeClass)))(function($p1){
                var activeObject = $p1;
                return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$removeClass)(ConstantsAndHelpers$activeClass))(activeObject)))(Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
                  var obj = $p1;
                  return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$addClass)(Fay$$list("active")))(obj)))(Fay$$_(action)(obj));
                }));
              });
            });
          };
...
var FayExtras$updateNavItem = function($p1){
  return function($p2){
    return function($p3){
      return function($p4){
        return function($p5){
          return new Fay$$$(function(){
            var element = $p5;
            var deactiveAction = $p3;
            var activateAction = $p2;
            var pos = $p1;
            return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
              var navObject = $p1;
              return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttrDouble)(ConstantsAndHelpers$startData))(navObject)))(function($p1){
                var start = $p1;
                return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttrDouble)(ConstantsAndHelpers$endData))(navObject)))(function($p1){
                  var end = $p1;
                  return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Fay$$_(FayExtras$isInRange)(pos))(Fay$$list([start,end]))) ? Fay$$_(Fay$$_(Fay$$then)(Fay$$_(activateAction)(navObject)))(Fay$$_(Fay$$_(JQuery$addClass)(ConstantsAndHelpers$activeClass))(navObject)) : Fay$$_(Fay$$_(Fay$$then)(Fay$$_(deactiveAction)(navObject)))(Fay$$_(Fay$$_(JQuery$removeClass)(ConstantsAndHelpers$activeClass))(navObject))))(Fay$$_(Fay$$$_return)(true));
                });
              });
            });
          });
...
var FayExtras$isInRange = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      if (Fay$$listLen(Fay$$_($p2),2)) {
        var start = Fay$$index(0,Fay$$_($p2));
        var end = Fay$$index(1,Fay$$_($p2));
        var pos = $p1;
        return Fay$$_(Fay$$_(Fay$$and)(Fay$$_(Fay$$_(Fay$$gte)(pos))(start)))(Fay$$_(Fay$$_(Fay$$lte)(pos))(end));
      }
      throw ["unhandled case in isInRange",[$p1,$p2]];
    });
  };
};
var FayExtras$addParallaxEffect = function($p1){
  return function($p2){
    return function($p3){
      return function($p4){
        return new Fay$$$(function(){
          ...
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
            var object = $p1;
            return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttrDouble)(ConstantsAndHelpers$speedData))(object)))(function($p1){
              var speed = $p1;
              return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttrDouble)(ConstantsAndHelpers$offsetData))(object)))(function($p1){
                var offset = $p1;
                return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FayExtras$visibility)(object)))(function($p1){
                  var vis = $p1;
                  return Fay$$_(Fay$$_(Fay$$then)((function($tmp1){
                    ...
                    if (Fay$$_($tmp1) instanceof $_Prelude$Just) {
                      var newPosition = Fay$$_($tmp1).slot1;
                      return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$jshow)(JQuery$Instantly))(object)))((function(){
                        var setPosition = new Fay$$$(function(){
                          return (function($tmp2){
                            if (Fay$$_($tmp2) instanceof $_FayExtras$Horizontal) {
                              return FFIExtras$setPositionY;
                            }
                            if (Fay$$_($tmp2) instanceof $_FayExtras$Vertical) {
                              return FFIExtras$setPositionX;
                            }
                            return (function(){ throw (["unhandled case",$tmp2]); })();
                          })(dir);
                        });
                        return Fay$$_(Fay$$_(setPosition)(newPosition))(object);
                      })());
                    }
                    return (function(){ throw (["unhandled case",$tmp1]); })();
                  })(Fay$$_(Fay$$_(Fay$$_(Fay$$_(FayExtras$movement)(vis))(speed))(offset))(pos))))(Fay$$_(Fay$$$_return)(true));
                });
              });
            });
          });
...
var FayExtras$movement = function($p1){
  return function($p2){
    return function($p3){
      return function($p4){
        return new Fay$$$(function(){
          ...
          var c = $p3;
          var speed = $p2;
          if (Fay$$_($p1) instanceof $_FayExtras$Always) {
            return Fay$$_(Prelude$Just)(Fay$$_(Fay$$_(Fay$$add)(Fay$$_(Fay$$_(Fay$$mult)(speed))(pos)))(c));
          }
          var pos = $p4;
          var c = $p3;
          var speed = $p2;
          if (Fay$$_($p1) instanceof $_FayExtras$Range) {
            var start = Fay$$_($p1).slot1;
            var end = Fay$$_($p1).slot2;
            if (Fay$$_(Fay$$_(Fay$$_(FayExtras$isInRange)(pos))(Fay$$list([start,end])))) {
              return Fay$$_(Prelude$Just)(Fay$$_(Fay$$_(Fay$$add)(Fay$$_(Fay$$_(Fay$$mult)(speed))(pos)))(c));
            } else {if (true) {
                return Prelude$Nothing;
              }
...
var FayExtras$visibility = function($p1){
  return new Fay$$$(function(){
    var obj = $p1;
    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttr)(ConstantsAndHelpers$visibilityData))(obj)))(function($p1){
      var visibility = $p1;
      return (function($tmp1){
        if (Fay$$equal($tmp1,Fay$$list("always"))) {
          return Fay$$_(Fay$$$_return)(FayExtras$Always);
        }
        if (Fay$$equal($tmp1,Fay$$list("range"))) {
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttrDouble)(ConstantsAndHelpers$startData))(obj)))(function($p1){
            var start = $p1;
            return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttrDouble)(ConstantsAndHelpers$endData))(obj)))(function($p1){
              var end = $p1;
              return Fay$$_(Fay$$$_return)(Fay$$_(Fay$$_(FayExtras$Range)(start))(end));
            });
          });
        }
        return (function(){ throw (["unhandled case",$tmp1]); })();
...
var FayExtras$addScrollAnimation = function($p1){
  return function($p2){
    return function($p3){
      return function($p4){
        return new Fay$$$(function(){
          ...
          return (function(){
            var onClick = function($p1){
              return new Fay$$$(function(){
                return Fay$$_(Fay$$_(Fay$$bind)(FFIExtras$body))(function($p1){
                  var bodyElem = $p1;
                  return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$getScrollTop)(bodyElem)))(function($p1){
                    var oldPosition = $p1;
                    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
                      var object = $p1;
                      return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttrDouble)(ConstantsAndHelpers$scrollPositionData))(object)))(function($p1){
                        var position = $p1;
                        return (function(){
                          ...
                          var scrollTo = new Fay$$$(function(){
                            return (function($tmp1){
                              if (Fay$$_($tmp1) instanceof $_FayExtras$Horizontal) {
                                return FFIExtras$animateScrollTop;
                              }
                              if (Fay$$_($tmp1) instanceof $_FayExtras$Vertical) {
                                return FFIExtras$animateScrollLeft;
                              }
                              return (function(){ throw (["unhandled case",$tmp1]); })();
                            })(dir);
                          });
                          return Fay$$_(Fay$$_(Fay$$_(scrollTo)(position))(duration))(bodyElem);
                        })();
                      });
                    });
                  });
...
var FayExtras$addHover = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        var leaveAction = $p3;
        var enterAction = $p2;
        var object = $p1;
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttr)(ConstantsAndHelpers$hoverObjectData))(object)))(function($p1){
          var hoverName = $p1;
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$select)(hoverName)))(function($p1){
            var hoverObject = $p1;
            return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Fay$$_(FFIExtras$hoverEnterLeave)(Fay$$_(enterAction)(object)))(Fay$$_(leaveAction)(object)))(hoverObject)))(Fay$$_(Fay$$$_return)(true));
          });
        });
      });
    };
...
var FayExtras$preloadImage = function($p1){
  return new Fay$$$(function(){
    var picturePath = $p1;
    return (function(){
      var imgSrc = new Fay$$$(function(){
        return Fay$$_(Fay$$_(Prelude$$43$$43$)(Fay$$list("\u003cimg src='")))(Fay$$_(Fay$$_(Prelude$$43$$43$)(picturePath))(Fay$$list("' alt='preload'/\u003e")));
      });
      return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$select)(ConstantsAndHelpers$preloadId)))(function($p1){
        var divPreload = $p1;
        return Fay$$_(Fay$$_(FFIExtras$prependString)(imgSrc))(divPreload);
      });
    })();
  });
};
...
var Fay$CKDesign$Parallax$main = new Fay$$$(function(){
  return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(FFIExtras$$_window)))(function($p1){
    var win = $p1;
    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FFIExtras$windowWidth)(win)))(function($p1){
      var width = $p1;
      return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Prelude$when)(Fay$$_(Fay$$_(Fay$$gt)(width))(768)))(Fay$$_(Fay$$_(JQuery$scroll)(Fay$CKDesign$Parallax$onScroll))(win))))(Fay$$_(Fay$$_(JQuery$documentReady)(Fay$CKDesign$Parallax$onReady))(FFIExtras$document));
    });
  });
});
var Fay$CKDesign$Parallax$onReady = function($p1){
  return new Fay$$$(function(){
    return (function(){
      var scrollSpeed = 0.5;
      var deactivateNavSlide = function($p1){
        return new Fay$$$(function(){
          var obj = $p1;
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$removeClass)(ConstantsAndHelpers$navSlideClass))(obj)))(Fay$$_(Fay$$$_return)(Fay$$unit));
        });
      };
      return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(FFIExtras$$_window)))(function($p1){
        var win = $p1;
        return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(FFIExtras$triggerScroll)(win)))(Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FFIExtras$windowWidth)(win)))(function($p1){
          var width = $p1;
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$select)(ConstantsAndHelpers$bubbleImageClass)))(function($p1){
            var bubbleImages = $p1;
            return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Fay$$_(Fay$$lte)(width))(768)) ? Fay$$_(Fay$$_(JQuery$each)(Fay$CKDesign$Parallax$turnOffBubbleEffect))(bubbleImages) : Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FayExtras$selectClass)(ConstantsAndHelpers$blackWhiteClass)))(function($p1){
              var blackWhiteElements = $p1;
              return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(Fay$CKDesign$Parallax$addChangeImageHover))(blackWhiteElements)))(Fay$$_(Fay$$_(JQuery$each)(Fay$CKDesign$Parallax$addBubbleEffect))(bubbleImages));
            })))(Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FayExtras$selectClass)(ConstantsAndHelpers$navItemClass)))(function($p1){
              var navigationElements = $p1;
              return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(Fay$$_(Fay$$_(FayExtras$addScrollAnimation)(FayExtras$Horizontal))(scrollSpeed)))(navigationElements)))(Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(Fay$$_(FayExtras$addActive)(deactivateNavSlide)))(navigationElements)))(Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(Fay$CKDesign$Parallax$addChangeMarginHover))(navigationElements)))(Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FayExtras$selectClass)(ConstantsAndHelpers$linkClass)))(function($p1){
                var linkElements = $p1;
                return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(FayExtras$addHref))(linkElements)))(Fay$$_(Fay$$$_return)(Fay$$unit));
              }))));
            }));
          });
        }));
...
var Fay$CKDesign$Parallax$onScroll = function($p1){
  return new Fay$$$(function(){
    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(FFIExtras$$_window)))(function($p1){
      var win = $p1;
      return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$getScrollTop)(win)))(function($p1){
        var pos = $p1;
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(FayExtras$selectClass)(ConstantsAndHelpers$movableClass)))(function($p1){
          var movableObjects = $p1;
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(Fay$$_(Fay$$_(FayExtras$addParallaxEffect)(FayExtras$Horizontal))(pos)))(movableObjects)))(Fay$$_(Fay$$$_return)(Fay$$unit));
        });
      });
    });
  });
};
var Fay$CKDesign$Parallax$addChangeImageHover = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      var element = $p2;
      var i = $p1;
      return (function(){
        var onChange = function($p1){
          return function($p2){
            return function($p3){
              return new Fay$$$(function(){
                var pictureObject = $p2;
                var isEnter = $p1;
                return (function(){
                  var pictureData = new Fay$$$(function(){
                    return Fay$$_(isEnter) ? ConstantsAndHelpers$mouseEnterData : ConstantsAndHelpers$mouseLeaveData;
                  });
                  return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttr)(pictureData))(pictureObject)))(function($p1){
                    var pictureName = $p1;
                    return (function(){
                      var imageOver = new Fay$$$(function(){
                        return Fay$$_(Fay$CKDesign$Parallax$prependPortfolioPrefix)(pictureName);
                      });
                      return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(FayExtras$preloadImage)(imageOver)))(Fay$$_(Fay$$_(FFIExtras$setBackgroundImage)(imageOver))(pictureObject));
                    })();
                  });
                })();
              });
        ...
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
          var hoverObject = $p1;
          return Fay$$_(Fay$$_(Fay$$_(FayExtras$addHover)(hoverObject))(Fay$$_(onChange)(true)))(Fay$$_(onChange)(false));
        });
      })();
    });
  };
};
var Fay$CKDesign$Parallax$addChangeMarginHover = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      var element = $p2;
      var i = $p1;
      return (function(){
        var addNavSlide = function($p1){
          return function($p2){
            return new Fay$$$(function(){
              var object = $p1;
              return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$addClass)(ConstantsAndHelpers$navSlideClass))(object)))(Fay$$_(Fay$$$_return)(Fay$$unit));
            });
          };
        };
        var removeNavSlide = function($p1){
          return function($p2){
            return new Fay$$$(function(){
              var object = $p1;
              return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(JQuery$hasClass)(ConstantsAndHelpers$activeClass))(object)))(function($p1){
                var hasActiveClass = $p1;
                return Fay$$_(hasActiveClass) ? Fay$$_(Fay$$$_return)(Fay$$unit) : Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$removeClass)(ConstantsAndHelpers$navSlideClass))(object)))(Fay$$_(Fay$$$_return)(Fay$$unit));
              });
            });
          };
        };
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
          var hoverObject = $p1;
          return Fay$$_(Fay$$_(Fay$$_(FayExtras$addHover)(hoverObject))(addNavSlide))(removeNavSlide);
        });
      })();
    });
  };
};
var Fay$CKDesign$Parallax$addBubbleEffect = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      var element = $p2;
      var i = $p1;
      return (function(){
        var changeBubble = function($p1){
          return function($p2){
            return function($p3){
              return new Fay$$$(function(){
                var updateClass = $p1;
                return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
                  var bubbleObject = $p1;
                  return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttr)(ConstantsAndHelpers$hoverClassData))(bubbleObject)))(function($p1){
        ...
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
          var bubbleObject = $p1;
          return Fay$$_(Fay$$_(Fay$$_(FayExtras$addHover)(bubbleObject))(Fay$$_(changeBubble)(JQuery$addClass)))(Fay$$_(changeBubble)(JQuery$removeClass));
        });
      })();
    });
  };
};
var Fay$CKDesign$Parallax$turnOffBubbleEffect = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      var element = $p2;
      return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
        var object = $p1;
        return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$removeClass)(ConstantsAndHelpers$scaleZeroClass))(object)))(Fay$$_(Fay$$$_return)(true));
      });
    });
  };
};
var Fay$CKDesign$Parallax$hoverElement = function($p1){
  return new Fay$$$(function(){
    var object = $p1;
    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(FFIExtras$dataAttr)(ConstantsAndHelpers$hoverObjectData))(object)))(JQuery$select);
  });
};
var Fay$CKDesign$Parallax$navigationPrefix = new Fay$$$(function(){
  return Fay$$list("images/navigation/");
});
var Fay$CKDesign$Parallax$portfolioPrefix = new Fay$$$(function(){
  return Fay$$list("images/portfolio/");
});
var Fay$CKDesign$Parallax$prependNavigationPrefix = new Fay$$$(function(){
  return Fay$$_(Prelude$$43$$43$)(Fay$CKDesign$Parallax$navigationPrefix);
});
var Fay$CKDesign$Parallax$prependPortfolioPrefix = new Fay$$$(function(){
  return Fay$$_(Prelude$$43$$43$)(Fay$CKDesign$Parallax$portfolioPrefix);
});
...
var $_FayExtras$Always = function(){
};
var $_FayExtras$Range = function(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
var $_FayExtras$Horizontal = function(){
};
var $_FayExtras$Vertical = function(){
};
var Fay$$fayToJsUserDefined = function(type,obj){
  ...
  if (_obj instanceof $_FayExtras$Always) {
    var obj_ = {"instance": "Always"};
    return obj_;
  }
  if (_obj instanceof $_FayExtras$Range) {
  ...
  if (_obj instanceof $_FayExtras$Horizontal) {
    var obj_ = {"instance": "Horizontal"};
    return obj_;
  }
  if (_obj instanceof $_FayExtras$Vertical) {
    var obj_ = {"instance": "Vertical"};
    return obj_;
  }
  return obj;
};
var Fay$$jsToFayUserDefined = function(type,obj){
  ...
  if (obj["instance"] === "Range") {
    return new $_FayExtras$Range(Fay$$jsToFay_double(obj["slot1"]),Fay$$jsToFay_double(obj["slot2"]));
  }
  if (obj["instance"] === "Horizontal") {
    return new $_FayExtras$Horizontal();
  }
  if (obj["instance"] === "Vertical") {
    return new $_FayExtras$Vertical();
  }
  return obj;
};
...
// Exports
this.Fay$CKDesign$Parallax$addBubbleEffect = Fay$CKDesign$Parallax$addBubbleEffect;
this.Fay$CKDesign$Parallax$addChangeImageHover = Fay$CKDesign$Parallax$addChangeImageHover;
this.Fay$CKDesign$Parallax$addChangeMarginHover = Fay$CKDesign$Parallax$addChangeMarginHover;
this.Fay$CKDesign$Parallax$hoverElement = Fay$CKDesign$Parallax$hoverElement;
this.Fay$CKDesign$Parallax$main = Fay$CKDesign$Parallax$main;
this.Fay$CKDesign$Parallax$navigationPrefix = Fay$CKDesign$Parallax$navigationPrefix;
this.Fay$CKDesign$Parallax$onReady = Fay$CKDesign$Parallax$onReady;
this.Fay$CKDesign$Parallax$onScroll = Fay$CKDesign$Parallax$onScroll;
this.Fay$CKDesign$Parallax$portfolioPrefix = Fay$CKDesign$Parallax$portfolioPrefix;
this.Fay$CKDesign$Parallax$prependNavigationPrefix = Fay$CKDesign$Parallax$prependNavigationPrefix;
this.Fay$CKDesign$Parallax$prependPortfolioPrefix = Fay$CKDesign$Parallax$prependPortfolioPrefix;
this.Fay$CKDesign$Parallax$turnOffBubbleEffect = Fay$CKDesign$Parallax$turnOffBubbleEffect;
...
;
var main = new Fay$CKDesign$Parallax();
main._(main.Fay$CKDesign$Parallax$main);
